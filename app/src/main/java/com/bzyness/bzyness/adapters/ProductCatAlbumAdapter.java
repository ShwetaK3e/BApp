...
public class ProductCatAlbumAdapter extends RecyclerView.Adapter<ProductCatAlbumAdapter.Holder> {
    ...
    public ProductCatAlbumAdapter(Context context, List<String> imagesURI, OnMyItemClickListener onMyItemClickListener) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView= LayoutInflater.from(parent.getContext()).inflate(R.layout.product_cat_album_grid,parent,false);
